...
> {
	 ...
	 * consistent reads on global secondary indexes, and the method
	 * overloads gate the option off at the type level on index queries.
	 */
...
> {
	...
	> {
		...
		const { cursor, filter, select, consistentRead } = options;
